<%-- 
    Document   : dashboard
    Created on : 13 jun. 2022, 09:13:37
    Author     : alanm
--%>

<%@page import="escom.ipn.restaurantes.data.dto.TrabajadorDTO"%>
<%@page import="escom.ipn.restaurantes.data.dto.DTO"%>
...
dto = (TrabajadorDTO)sesionOk.getAttribute("user");
usuario = dto.getTrabajador().getNombreTrabajador().concat(" ").concat(dto.getTrabajador().getApellidoPaterno()).concat(" ").concat(dto.getTrabajador().getApellidoMaterno());
}
%> <%=usuario%>
                                </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <form method="GET" action="CerrarSesion">
                    ...
                    <div class="row" style="display: flex; justify-content:center;">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Jitomate <span
                                            class="float-right">20%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 20%"
                                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Zanahoria <span
                                            class="float-right">40%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Tomate <span
                                            class="float-right">60%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar" role="progressbar" style="width: 60%"
                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Cebolla<span
                                            class="float-right">80%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Chile<span
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Selecciona "Salir" debajo si estás listo para salir.</div>
