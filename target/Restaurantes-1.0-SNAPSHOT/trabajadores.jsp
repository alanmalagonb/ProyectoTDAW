<%-- 
    ...
    Created on : 18 jun. 2022, 16:16:45
    Author     : alanm
--%>
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="display: flex; flex-direction: column; align-items: center; max-width: 60vw;">
                    <div style="background:white; border-radius: 10px; padding: 10px; box-shadow: 3px 3px 5px 5px lightgray; width: 100%">
                        ...
                        <div class="card-body">
                            <form style="padding: 20px" form action="AgregarTrabajadorSucursal" method="post">
                                <div class="mb-3">
                    ...
                    <div style="background:white; border-radius: 10px; padding: 10px; box-shadow: 3px 3px 5px 5px lightgray; width: 100%;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lista Trabajadores</h6>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr style="background-color: #4e73df;">
                                        ...
                                        <th scope="col"><font color="white">Sucursal</font></th>
                                        <th scope="col"><font color="white">Rol</font></th>
                                        <th scope="col"><font color="white">Acción</font></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <% 
                                    ...
                                    for(TrabajadorDTO r : tdao.getAllFromRestaurante(rdto)){
                                    
                                    
                                    %>
                                    <tr>
                                        <td><%= r.getTrabajador().getNombreTrabajador() %></td>
                                        <td><%= r.getSucursal().getNombreSucursal() %></td>
                                        <td><%= r.getRol().getNombreRol() %></td>
                                        <td align="center">
                                            <a class="btn btn-warning" href="editarTrabajadorS.jsp?id=<%=r.getTrabajador().getEmail()%>">Editar</a>
                                            <a class="btn btn-danger " href="EliminarTrabajadorS?id=<%=r.getTrabajador().getEmail()%>">Eliminar</a>
                                        </td>
                                    </tr>
                                    <%}%>
                                </tbody>
