<%-- 
    Document   : inventario
    Created on : 18 jun. 2022, 22:31:17
    Author     : alanm
--%>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="display: flex; flex-direction: column; align-items: center; max-width: 60vw;">
                    <div style="background:white; border-radius: 10px; padding: 10px; box-shadow: 3px 3px 5px 5px lightgray; width: 100%">
                        ...
                        <div class="card-body">
                            <form style="padding: 20px">
                                <div class="mb-3">
                                    <label for="formGroupExampleInput" class="form-label">Datos Ingrediente</label>
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" id="Nombre" name="Nombre" class="form-control" placeholder="Nombre Ingrediente" aria-label="Nombre Ingrediente" required>
                                        </div>
                                    </div>
                                    <br/>
                                    <div class="row">
                                        <div class="col">
                                            <input type="number" min="1" id="StcokActual" name="StcokActual" class="form-control" placeholder="Stock necesario" aria-label="Stock necesario" required>
                                        </div>
                                        <div class="col">
                                            <input type="number" min="0" id="StcokNecesario" name="StcokNecesario" class="form-control" placeholder="Stock actual" aria-label="Stock actual" required>
                                        </div>
                                        <div class="col">
                                            <select id="Medida" name="Medida" class="custom-select custom-select-sm form-control form-control-sm" aria-label="Default select example">
                                                <option id='0'>Selecciona Medida</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div style="background:white; border-radius: 10px; padding: 10px; box-shadow: 3px 3px 5px 5px lightgray; width: 100%;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lista Ingredientes</h6>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr style="background-color: #4e73df;">
                                        ...
                                        <th scope="col"><font color="white">Stock<br/>necesario</font></th>
                                        <th scope="col"><font color="white">Stock<br/>actual</font></th>
                                        <th scope="col"><font color="white">Unidad<br/>medida</font></th>
                                        <th scope="col"><font color="white">Accion</font></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
